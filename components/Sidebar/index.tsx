        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/agents" || pathname.includes("agents")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/agents/all-agent"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/agents/all-agent" && "text-white"
                              }`}
                            >
                              All
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/agents/master-agent"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/agents/master-agent" &&
                                "text-white"
                              }`}
                            >
                              Master Agent
                          ...
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/agents/customer-service" &&
                                "text-white"
                              }`}
                            >
                              Customer Service
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/pages/home"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/pages/home" && "text-white"
                              }`}
                            >
                              Home
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/pages/account-creation"
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/pages/account-creation" &&
                                "text-white"
                              }`}
                            >
                              Account Creation
                          ...
                          <li>
                            <Link
                              href="/pages/blog"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/pages/blog" && "text-white"
                              }`}
                            >
                              Blog
                            </Link>
