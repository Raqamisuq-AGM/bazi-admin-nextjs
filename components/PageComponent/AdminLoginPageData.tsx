      ...
      const response = await axios
        ...
        .then(function (response) {
          ...
          if (response.data.message == "Invalid credentials") {
            ...
            router.push("/");
            Cookies.set("baziAdm", response.data.data.password, {
              expires: 365,
            });
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mb-5 flex">
                ...
                >
                  {isAdding ? "Please wait..." : "Login"}
                </button>
                <Link
                  href="/forget-password"
                  className="inline-flex items-center justify-center rounded-md bg-black py-4 px-10 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10 ml-3"
                >
                  Forget Password
                </Link>
              </div>
